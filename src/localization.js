const localizationList = [
	{
		...
		strings: [
			...
			[ "SKILL_ALCHEMY_DESC", "Mixing of formulaic compounds for wondrous effects." ],
			[ "SKILL_APPRAISE", "Appraise" ],
			[ "SKILL_APPRAISE_ABBR", "App" ],
			[ "SKILL_APPRAISE_DESC", "Determining the value of items." ],
			[ "SKILL_ARTIFICE", "Artifice" ],
			[ "SKILL_ARTIFICE_ABBR", "Art" ],
			[ "SKILL_ARTIFICE_DESC", "Performing minute tasks with one's hands." ],
			[ "SKILL_LITERACY", "Literacy" ],
			[ "SKILL_LITERACY_ABBR", "Lit" ],
			[ "SKILL_LITERACY_DESC", "Reading and writing." ],
			[ "SKILL_MELEE", "Melee" ],
			[ "SKILL_MELEE_ABBR", "Mle" ],
			[ "SKILL_MELEE_DESC", "Proficiency in close combat." ],
			[ "SKILL_PARRY", "Parry" ],
			[ "SKILL_PARRY_ABBR", "Pry" ],
			[ "SKILL_PARRY_DESC", "Defending against attacks." ],
			[ "SKILL_PERSUASION", "Persuasion" ],
			[ "SKILL_PERSUASION_ABBR", "Prs" ],
			[ "SKILL_PERSUASION_DESC", "Convincing others." ],
			[ "SKILL_RANGED", "Ranged" ],
			[ "SKILL_RANGED_ABBR", "Rng" ],
			[ "SKILL_RANGED_DESC", "Proficiency with ranged weapons." ],
			[ "SKILL_RELIGION", "Religion" ],
			[ "SKILL_RELIGION_ABBR", "Rel" ],
			[ "SKILL_RELIGION_DESC", "Learning the intricacies of faith." ],
			[ "SKILL_RIDE", "Ride" ],
			[ "SKILL_RIDE_ABBR", "Rid" ],
			[ "SKILL_RIDE_DESC", "Controlling a mount." ],
			[ "SKILL_STEALTH", "Stealth" ],
			[ "SKILL_STEALTH_ABBR", "Stl" ],
			[ "SKILL_STEALTH_DESC", "Avoiding detection" ],
			[ "SKILL_WOODCRAFT", "Woodcraft" ],
			[ "SKILL_WOODCRAFT_ABBR", "WdC" ],
			[ "SKILL_WOODCRAFT_DESC", "Surviving in the wilderness." ],
